...
VIPER/RIB apps can create an app-owned router adapter at the boundary, then let builders assemble the module without exposing `ACRouting` to presenters or interactors:
